...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        'flex h-11 w-full rounded-md border-transparent bg-transparent py-3 text-sm outline-none placeholder:text-neutral-400 focus:border-transparent focus:ring-0 disabled:cursor-not-allowed disabled:opacity-50 dark:text-neutral-50',
        className
      )}
      {...props}
    />
