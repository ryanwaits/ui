...
const buttonVariants = (0, class_variance_authority_1.cva)('inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-neutral-400 focus:ring-offset-2 dark:hover:bg-neutral-800 dark:hover:text-neutral-100 disabled:opacity-50 dark:focus:ring-neutral-400 disabled:pointer-events-none dark:focus:ring-offset-neutral-900 data-[state=open]:bg-neutral-100 dark:data-[state=open]:bg-neutral-800', {
    variants: {
        variant: {
...
const Button = react_1.default.forwardRef((_a, ref) => {
    ...
    return (react_1.default.createElement("button", Object.assign({ className: (0, utils_1.cn)(buttonVariants({ variant, size, className })), ref: ref }, props)));
});
